  ...
  return (
    <div>
      <button
        ...
        className="flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white transition-all hover:bg-emerald-700"
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <input type="text" placeholder="Nome completo" value={form.nome} required
                ...
                className="rounded-xl border border-line px-4 py-3 text-sm outline-none focus:border-emerald-600" />
              ...
              <div>
                <input type="text" placeholder="Slug (URL)" value={form.slug} required
                  ...
                  className="w-full rounded-xl border border-line px-4 py-3 text-sm outline-none focus:border-emerald-600" />
